...
public class TransactionController {
    ...
    @GetMapping
    public Page<Transaction> index(TransactionFilter filter,@PageableDefault(size = 10) Pageable pageable) {
       //Pageable pageable - Fornecendo paginação para o Front
       // a Anatoção @PageableDefault(size = 10) - Define a qtd de registros por pág 
